    ...
    <>
      ...
      <nav className="mobile-nav glass-panel">
        <div className="mobile-nav-items">
          ...
          {/* Center Book Button with Pulse - Premium OM Symbol */}
          <button className="main-action pulse-gold cursor-pointer" style={{ position: 'relative' }} onClick={() => {
               setView('home');
            ...
            <div style={{
              ...
              height: '100%',
              borderRadius: '50%',
              background: 'linear-gradient(135deg, #D4AF37, #facd49)',
              display: 'flex',
              alignItems: 'center',
